...
Pre and post ordering and the edge types look like this:
...
When drawing the residuals make sure you draw the flow you've already used backwards, so some paths with have an arror going forward and an arrow going backward.
